            ...
            <>
              {selectedHalfProduct && (
                <div className="mb-1 flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Pizza meio a meio</span>
                  <span className="font-semibold">{currency(basePrice)}</span>
                </div>
              )}
              <div className="mb-3 flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Total</span>
                <span className="text-base font-bold">{currency(basePrice + extraTotal)}</span>
              </div>
            </>
          ) : (
            <div className="mb-3 flex items-center justify-between text-sm">
              <span className="text-muted-foreground">Adicionais</span>
              <span className="text-base font-bold">{currency(extraTotal)}</span>
            </div>
          )}
